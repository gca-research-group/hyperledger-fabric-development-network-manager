...
const DEFAULT_FABRIC_VERSION = "2.5.14"
const DEFAULT_BATCH_TIMEOUT = "2s"
const DEFAULT_BATCH_SIZE_MAX_MESSAGE_COUNT = "10"
const DEFAULT_BATCH_SIZE_ABSOLUTE_MAX_BYTES = "99 MB"
const DEFAULT_BATCH_SIZE_PREFERRED_MAX_BYTES = "512 KB"
