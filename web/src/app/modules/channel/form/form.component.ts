...
import { OrdererSelectorComponent } from '@app/components/orderer-selector/orderer-selector.component';
import { PeerSelectorComponent } from '@app/components/peer-selector';
...
@Component({
  ...
  imports: [
    ...
    InputComponent,
    ButtonComponent,
    PeerSelectorComponent,
    OrdererSelectorComponent,
  ],
})
