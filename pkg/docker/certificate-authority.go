	...
	node := yaml.MappingNode(
		...
		yaml.MappingNode(
			...
			yaml.SequenceNode(
				...
				yaml.ScalarNode(fmt.Sprintf("./%s/certificates/fabric-ca-client:/etc/hyperledger/fabric-ca-client", organization.Domain)),
				//yaml.ScalarNode(fmt.Sprintf("./%s/certificates/orderers:/etc/hyperledger/%s/orderers", organization.Domain, organization.Domain)),
				//yaml.ScalarNode(fmt.Sprintf("./%s/certificates/peers:/etc/hyperledger/%s/peers", organization.Domain, organization.Domain)),
				yaml.ScalarNode(fmt.Sprintf("./%s/certificates/crypto-material:/etc/hyperledger/crypto-material", organization.Domain)),
			),
